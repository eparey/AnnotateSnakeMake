...
rule format_aug_for_pasa:
    input:  "results/filter_models/gene_models.filt.0.6.gff3"#f"results/augustus/gene_models_filter0.6.gff3" #f"results/augustus/{GENOME}.aug.gff3"
...
rule clean_after_pasa:
    ...
    shell: "rm -r  __pasa_GenomeMik.sqlite* || true && rm GenomeMik.sqlite* || true && "
           ...
           "rm blat.spliced_alignments.gff3 || true && rm 11.ooc && rm tmp-* || true &&  rm -r pblat_outdir/ || true && "
